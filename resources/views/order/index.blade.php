                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                <div class="card">
                                                    <div class="card-header d-flex justify-content-between">
                                                        ...
                                                        <a href="{{ route('order.create') }}" class="btn btn-outline-primary btn-sm align-self-center">Add New</a>
                                                    </div>
                                                    <div class="card-body">
                                                            ...
                                                            <div class="col-sm-12">
                                                                ...
                                                                <thead>
                                                                    <tr role="row">
                                                                        ...
                                                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 127.778px;">Items</th>
                                                                        ...
                                                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style="width: 123.333px;">Total</th>
                                                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 127.778px;">Date</th>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr role="row" class="odd">
                                                                        ...
                                                                        <td>{{ $order->price }}</td>
                                                                        <td>{{ $order->code_book }}</td>
                                                                        <td class="d-flex inline-block justify-content-around">
                                                                            <a href="{{ route('order.edit', ['id'=>$order->id]) }}" class="btn btn-outline-warning btn-sm">Edit</a>
